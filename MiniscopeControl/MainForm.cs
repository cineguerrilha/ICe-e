...
namespace NationalInstruments.Examples.ContAcqVoltageSamples_IntClk_ToFile
{
    ...
    public class MainForm : System.Windows.Forms.Form
    {
        ...
        private bool[] dataArray = new bool[8];
        ...
        public MainForm()
        {
            ...
            player = new System.Media.SoundPlayer(@"C:\Sounds\default.wav");
            ...
            try
            {
                ...
                for (int i = 0; i < 8; i++) dataArray[i] = false;
        ...
        private void InitializeComponent()
        {
            ...
            this.physicalChannelComboBox.Text = "Dev1/ai0:3";
            // 
            // minimumValueNumeric
            // 
            ...
            this.Text = "Miniscope Control - Neurodynamics Lab";
        ...
        private void browseWriteButton_Click(object sender, System.EventArgs e)
        {
            if (textFileWriteRadioButton.Checked) 
            {
                ...
                writeToFileSaveFileDialog.DefaultExt = "";
                writeToFileSaveFileDialog.FileName = "TextData";
                writeToFileSaveFileDialog.Filter = "All Files|*";
            }
            else
            {
                useTextFileWrite = false;
                writeToFileSaveFileDialog.DefaultExt = "";
                writeToFileSaveFileDialog.FileName = "BinData";
                writeToFileSaveFileDialog.Filter = "All Files|*";
            }
        ...
        private bool CreateDataFile()
        {
            try
            {
                fileNameNo = fileNameWrite + "_" + FNo.ToString();
                FileStream fs = new FileStream(fileNameNo, FileMode.Create);
                if (useTextFileWrite)
                {
