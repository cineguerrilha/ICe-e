...
namespace USB_Scope
{
    ...
    public class USBSource
    {
        ...
        private double[] synthSpikeOffset = { 52, -44, 13, 0, 73, -35, -21, 23, -54, -5, 2, 16, 89, -70, -10, 28 };

        private double[] synthSpikeAmp1 = { -100, -200, -150, -50, 0, 0, -140, -180, -30, -80, 0, -250, -130, -220, -60, -170 };
        private double[] synthSpikeAmp2 = { -160, -80, -100, -0, -120, 0, -240, -80, -30, -180, -150, -50, -170, -60, -220, -100 };

        private double[] synthSpikeWidth1 = { 25, 15, 30, 10, 22, 18, 12, 21, 28, 15, 12, 14, 17, 21, 9, 24 };
        private double[] synthSpikeWidth2 = { 40, 30, 42, 20, 24, 29, 30, 24, 35, 20, 21, 15, 22, 28, 15, 28 };
        ...
        /// <summary>
        /// Are we generating synthetic neural data for demo purposes
        /// (if RHA2000-EVAL board is not connected)?
        /// </summary>
        ...
        /// <summary>
        /// Flag for timer to trip every 30 ms to generate more synthetic spike data
        /// (if RHA2000-EVAL board is not connected)
        /// </summary>
